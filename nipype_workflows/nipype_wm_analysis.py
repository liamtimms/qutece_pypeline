...
def wm_analysis(working_dir, subject_list):
    ...
    combine_labels_wmh.inputs.multiplication_factor = 100
    # -------------------------------------------------------
    ...
    substitutions = [
        ...
        (
            ...
            "sblobs=25_splates=25_maths_resampled",
            "vesselness",
        ),
    ]
    ...
    wm_wf.connect([
        ...
        (
            selectfiles,
            combine_labels_wmh,
            [("nwm_seg", "in_file_fixed"), ("wmh_seg", "in_file_modifier")],
        ),
        (
            combine_labels_wmh,
