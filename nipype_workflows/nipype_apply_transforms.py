...
def apply_linear_trans(working_dir, subject_list, scan_type):
    ...
    trans_wf.connect([
        ...
        (
            selectfiles,
            apply_linear,
            [("mni_brain", "reference"), ("linear_matrix", "in_matrix_file")],
        ),
...
def apply_nonlinear_trans(working_dir, subject_list, session_list, scan_type):
    ...
    substitutions = [
        ("_subject_id_", "sub-"),
        ("_session_id_", "ses-"),
        ("desc-preproc_maths_flirt_maths_warp_ROI-labels_", "desc-processed_"),
    ]
    ...
    trans_wf.connect([
        ...
        (
            selectfiles,
            apply_nonlinear,
            [("mni_brain", "ref_file"), ("warp_field", "field_file")],
        ),
        ...
        (
            ...
            datasink,
            [
                ("out_mean_csv", task + "_meancsv.@con"),
...
def apply_linear_trans_morph(working_dir, subject_list, scan_type):
    ...
    apply_linear = eng.MapNode(fsl.ApplyXFM(),
                               ...
                               iterfield=["in_file"])
    apply_linear.inputs.no_resample = True
    apply_linear.inputs.interp = "nearestneighbour"
